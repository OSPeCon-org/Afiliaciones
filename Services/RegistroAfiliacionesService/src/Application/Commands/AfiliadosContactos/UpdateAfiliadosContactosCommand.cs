...
namespace OSPeConTI.Afiliaciones.RegistroAfiliaciones.Application.Commands
{
    ...
    public class UpdateAfiliadosContactosCommand : IRequest<bool>
    {
        ...
        public UpdateAfiliadosContactosCommand(Guid id, Guid afiliadosId, string celular, string particular, string laboral, Email mail, Email mail2, int cemapReferencia)
