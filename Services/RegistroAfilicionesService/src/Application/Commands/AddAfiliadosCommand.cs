...
namespace OSPeConTI.Afiliaciones.RegistroAfiliaciones.Application.Commands
{
    ...
    public class AddAfiliadosCommand : IRequest<Guid>
    {
        ...
        public AddAfiliadosCommand(string apellido, string nombre, Guid tipoDocumentoId, int documento, Guid parentescoId, string cuil, DateTime fechaNacimiento, Guid planId, string sexo, Guid estadoCivilId, bool discapacitado, Guid nacionalidadId)
