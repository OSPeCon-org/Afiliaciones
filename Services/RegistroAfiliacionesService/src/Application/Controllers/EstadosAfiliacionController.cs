...
namespace OSPeConTI.Afiliaciones.RegistroAfiliaciones.Application
{
    ...
    public class EstadosAfiliacionController : ControllerBase
    {
        ...
        [Route("add")]
        [HttpPost]
        public async Task<IActionResult> addEstadosAfiliacionAsync([FromBody] AddEstadosAfiliacionCommand command)
        {
        ...
        [AllowAnonymous]
        public async Task<IActionResult> updateEstadosAfiliacionAsync([FromBody] UpdateEstadosAfiliacionCommand command)
        {
