...
namespace OSPeConTI.Afiliaciones.RegistroAfiliaciones.Application.Commands
{
    ...
    public class UpdateDocumentacionCommandHandler : IRequestHandler<UpdateDocumentacionCommand, bool>
    {
        ...
        public UpdateDocumentacionCommandHandler(IDocumentacionRepository documentacionRepository, AfiliacionesContext AfiliacionesContext, IAfiliacionIntegrationEventService afiliacionIntegrationEventService)
        {
        ...
        public async Task<bool> Handle(UpdateDocumentacionCommand command, CancellationToken cancellationToken)
        {
            ...
            documentacionToUpdate.Update(command.Id, command.Descripcion, command.Discapacidad);
